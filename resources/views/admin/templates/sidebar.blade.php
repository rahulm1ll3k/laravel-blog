...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{ Route('admin.post') }}">All Posts</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ Route('admin.post.new') }}">Add Post</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{ Route('admin.author') }}">All Authors</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ Route('admin.author.new') }}">Add Author</a></li>
                </ul>
            </div>
        </li>
    </ul>
