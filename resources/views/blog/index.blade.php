...
<div class="site-section py-0">
    <div class="owl-carousel hero-slide owl-style">
                ...
                <div class="container">
                    <div class="half-post-entry d-block d-lg-flex bg-light">
                        ...
                        <div class="contents">
                            ...
                            <?php $blog_content = Str::of($slide->blog_content)->limit(250); ?>
                            <p class="mb-3">{{$blog_content}}</p>
                            <div class="post-meta">
                                <span class="d-block">
                                    <a href="{{'/author/'.strtolower($user[$slide->author])}}">{{$user[$slide->author]}}</a> in
                                    <a href="{{'/category/'.strtolower($post_cat[$slide->category])}}">{{$post_cat[$slide->category]}}</a></span>
                                </span>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image: url('{{ asset('assets/images/big_img_1.jpg') }}')"></div>
                    <div class="contents">
                        <span class="caption">Editor's Pick</span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="post-entry-1">
                            <a href="post-single.html"><img src="{{ asset('assets/images/img_h_1.jpg') }}" alt="Image" class="img-fluid"></a>
                            <h2><a href="blog-single.html">News Needs to Meet Its Audiences Where They Are</a></h2>
                    ...
                    <div class="col-md-6">
                        <div class="post-entry-2 d-flex bg-light">
                            <div class="thumbnail" style="background-image: url('{{ asset('assets/images/img_v_1.jpg') }}')"></div>
                            <div class="contents">
                                <h2><a href="blog-single.html">News Needs to Meet Its Audiences Where They Are</a></h2>
                                <div class="post-meta">
                                    <span class="d-block"><a href="#">Dave Rogers</a> in <a href="#">News</a></span>
                        ...
                        <div class="post-entry-2 d-flex">
                            <div class="thumbnail" style="background-image: url('{{ asset('assets/images/img_v_2.jpg') }}')"></div>
                            <div class="contents">
                                <h2><a href="blog-single.html">News Needs to Meet Its Audiences Where They Are</a></h2>
                                <div class="post-meta">
                                    <span class="d-block"><a href="#">Dave Rogers</a> in <a href="#">News</a></span>
                        ...
                        <div class="post-entry-2 d-flex">
                            <div class="thumbnail" style="background-image: url('{{ asset('assets/images/img_v_3.jpg') }}')"></div>
                            <div class="contents">
                                <h2><a href="blog-single.html">News Needs to Meet Its Audiences Where They Are</a></h2>
                                <div class="post-meta">
                                    <span class="d-block"><a href="#">Dave Rogers</a> in <a href="#">News</a></span>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="post-entry-2 d-flex">
                    <div class="thumbnail order-md-2" style="background-image: url('{{ asset('assets/images/img_h_4.jpg') }}')"></div>
                ...
                <div class="post-entry-2 d-flex">
                    <div class="thumbnail order-md-2" style="background-image: url('{{ asset('assets/images/img_h_3.jpg') }}')"></div>
                    <div class="contents order-md-1 pl-0">
                        <h2><a href="blog-single.html">News Needs to Meet Its Audiences Where They Are</a></h2>
                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi temporibus praesentium neque, voluptatum quam quibusdam.</p>
                        <div class="post-meta">
